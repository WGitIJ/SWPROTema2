...
//? el preu en € de cada hora, calcula que ha de cobrar aquesta persona en acabar la setmana. Suposa que totes les hores
...
public class horesFeina {
    public static void main(String[] args) {
        ...
        if (horasTrabajadas>40){
            ...
            System.out.println("Horas extra: " + horasExtra + " Salario Extra: " + salarioExtra);
        }
        salario = 40 * precioHora + salarioExtra;

        System.out.println("El salario neto es de: " + salario + "la hora");
